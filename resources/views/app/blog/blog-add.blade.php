    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="javascript:;" class="mt-2" id="new_form">
            @csrf 
            <input type="hidden" id="url" value="{{route('post.store')}}">  
            ...
            <div class="row">
              ...
              <div class="col-12 mb-2">
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    <img src="{{asset('images/slider/03.jpg')}}" id="blog-feature-image"
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="new_submit" class="btn btn-primary mr-1"> أضافة</button>
