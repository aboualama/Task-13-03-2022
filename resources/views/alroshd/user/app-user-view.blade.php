                ...
                <div class="d-flex justify-content-start">
                  ...
                  <div class="d-flex flex-column ml-1">
                    ...
                    <div class="d-flex flex-wrap">
                      ...
                      <a href="javascript:;" class="btn btn-outline-danger ml-1 confirm confirm_row_{{$user->id}}" onclick="confirmrow({{$user->id}})" data-id="{{ $user->id }}" data-location="10" data-route="user" data-a_name="{{$user->name}}"> Delete</a>
                    </div>
                  </div>
                </div>
              </div>
