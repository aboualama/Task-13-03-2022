...
class EmplCaderExport implements FromView, WithEvents, WithStyles, WithColumnWidths, WithDrawings
{
        ...
        return view('exports.excel.empl_cader', [
            'employees' => Employee::whereHas('jobs_history', function($query) {
                $query->where('currently', 1)
                    ...
                    ->whereNotIn('sub_group_id', ['22','23','24','25','26','27']);
             })->get()->orderBy('financial_degree_id', 'asc')->sortByDesc(function($query){
